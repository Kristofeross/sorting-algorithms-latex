...
może być ograniczany poprzez ustalenie maksymalnej głębokości równoległej rekurencji, co pozwala ograniczyć narzut związany z~tworzeniem 
i~synchronizacją wątków. Po osiągnięciu założonej głębokości dalsze sortowanie odbywa się sekwencyjnie.
...
traci natomiast na efektywności m.in. gdy podziały stają się nierównomiernie.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/chapter3/parallelQuicksort.png}
    \caption{Schemat działania Quicksort.}
...
Samplesort jest algorytmem sortowania wykorzystującym podział danych na wiele mniejszych kubełków na podstawie odpowiednio dobranych 
...
Istotną zaletą Samplesort jest możliwość wyznaczania granic podziału na podstawie informacji uzyskanych 
...
\begin{figure}[htbp]
    ...
    \caption{Schemat działania Samplesort.}
