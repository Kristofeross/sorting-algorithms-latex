...
Quick Sort należy do rodziny algorytmów opartych na strategii ``dziel i zwyciężaj'' (ang. \textit{divide-and-conquer})~\cite{bib:CLRS4}. 
...
związanym z silnie niezrównoważonym podziałem może wzrosnąć do $O(n^2)$~\cite{bib:CLRS4}.
...
traci natomiast na efektywności m.in. wtedy, gdy podziały stają się nierównomierne.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/chapter3/parallelQuicksort.png}
    \caption{Schemat działania Quick Sort. Źródło: opracowanie własne na podstawie \cite{bib:GoodrichC++}.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/chapter3/parallelMergeSort.png}
    \caption{Schemat działania Merge Sort. Źródło: opracowanie własne na podstawie \cite{bib:GoodrichC++}.}
    \label{fig:ms-merge}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Schemat działania Bucket Sort. Źródło: opracowanie własne na podstawie \cite{bib:CLRS4}.}
...
\begin{figure}[htbp]
    ...
    \caption{Schemat działania Sample Sort. Źródło: opracowanie własne na podstawie \cite{bib:ShiSchaeffer1992}.}
