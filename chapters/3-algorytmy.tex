...
Średnia złożoność obliczeniowa algorytmu Quick Sort wynosi $O(n\log n)$, 
jednak w przypadku silnie niezrównoważonych podziałów może wzrosnąć do $O(n^2)$~\cite{bib:CLRS4}.
