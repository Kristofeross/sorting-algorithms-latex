...
Umożliwiają one określenie, w~jakim stopniu zastosowanie wielu jednostek wykonawczych wpływa na czas rozwiązania
...
o rozmiarze $n$, natomiast $T_p(n)$ oznacza czas wykonania algorytmu równoległego przy wykorzystaniu
