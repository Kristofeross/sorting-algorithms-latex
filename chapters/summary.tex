...
The aim of this thesis is to analyze the performance and efficiency of selected parallel sorting algorithms on a multicore processor. 
...
and was approximately 1.20~s with 16 processing units.
...
The highest speedup was achieved by Sample Sort and was approximately 2.60, while for Bucket Sort, Merge Sort, 
and Quick Sort it reached approximately 1.80, 1.59, and 1.21, respectively.

The results showed that increasing the number of processing units did not always lead to shorter execution times, 
while the achieved efficiency depended on the algorithm used, the dataset size, and the characteristics of the input data. 
The greatest benefits from parallel processing were obtained for larger datasets. 
The conducted research confirmed that effective use of parallelism requires its level to be adapted to the
