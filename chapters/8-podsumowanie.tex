...
Uzyskane wyniki wykazały, że zastosowanie obliczeń równoległych prowadziło do skrócenia czasu sortowania,
...
Spośród badanych algorytmów najkrótsze czasy wykonania osiągał Bucket Sort, poprawiając rezultaty do 16 jednostek wykonawczych.
...
Dalsze zwiększanie liczby jednostek powyżej konfiguracji zapewniających najlepsze wyniki
prowadziło w~części przypadków do wydłużenia czasu wykonania, a~jednocześnie do spadku efektywności.
Dodatkowa diagnostyka wykazała również, że liczba zadeklarowanych jednostek wykonawczych 
nie zawsze odpowiadała liczbie faktycznie tworzonych procesów potomnych, szczególnie w~przypadku Quick Sort i~Merge Sort.
