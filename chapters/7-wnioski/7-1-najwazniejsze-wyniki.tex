...
nie przekładała się bezpośrednio na liczbę faktycznie tworzonych procesów.
...
Zależność pomiędzy liczbą zadeklarowanych jednostek wykonawczych
...
podczas gdy dla pozostałych algorytmów zmienność wyników była mniejsza.
