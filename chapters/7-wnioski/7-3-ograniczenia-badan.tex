...
Przeprowadzona dodatkowa diagnostyka wykazała, że liczba zadeklarowanych jednostek wykonawczych nie zawsze odpowiadała 
liczbie faktycznie tworzonych procesów potomnych, szczególnie w~przypadku Quick Sort i~Merge Sort.