...
Z~uzyskanych wyników wynika, że różnice wydajnościowe między algorytmami wynikały zarówno z~ich charakterystyki obliczeniowej,
...
nie musiało prowadzić do proporcjonalnego zwiększenia liczby tworzonych procesów.
...
Może to częściowo tłumaczyć, dlaczego dla zbioru \texttt{random\_int} najlepszy czas uzyskano przy 2 jednostkach wykonawczych,
...
natomiast dalsze zwiększanie ich liczby nie prowadziło już do poprawy wyniku.
