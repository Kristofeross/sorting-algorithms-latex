...
Wzrost liczby jednostek wykonawczych nie prowadził we wszystkich badanych konfiguracjach do skrócenia czasu sortowania, 
a~najkrótsze czasy osiągano przy różnej liczbie wykorzystywanych jednostek.
...
Przy 16 jednostkach nastąpiło niewielkie wydłużenie czasu wykonania do około 2,44~s. 
Dla 32 jednostek czas wykonania wzrósł natomiast wyraźnie do około 3,26~s.
...
W przypadku Sample Sort zależność była nieco odmienna dla obu typów danych. 
Dla danych całkowitych najkrótszy czas wykonania uzyskano przy 8 jednostkach wykonawczych, 
natomiast zwiększenie ich liczby do 16 spowodowało niewielkie wydłużenie czasu wykonania. 
Dla danych zmiennoprzecinkowych najkrótszy czas wykonania uzyskano natomiast przy 16 jednostkach wykonawczych.
Powtarzalność podobnych zależności dla obu typów danych sugeruje, że obserwowane zmiany wydajności 
mogły wynikać przede wszystkim ze sposobu realizacji równoległości badanych algorytmów, a~nie wyłącznie z~typu przetwarzanych wartości.
...
Uzyskane wyniki pokazują, że zwiększanie liczby zadeklarowanych jednostek wykonawczych nie prowadziło 
do~proporcjonalnego wzrostu liczby tworzonych procesów w~przypadku Quick Sort i~Merge Sort.
...
Wpływ tych czynników oceniono również na podstawie wykorzystania zasobów oraz uzyskanego przyspieszenia i~efektywności.