...
Wskazuje to, że samo zwiększenie obciążenia CPU nie musi prowadzić do poprawy czasu wykonania.
...
co mogło ograniczać możliwość uchwycenia rzeczywistego poziomu obciążenia CPU. 
...
Wskazuje to, że zwiększenie poziomu równoległości może wiązać się z~dodatkowym kosztem pamięciowym, 
który nie musi być rekompensowany poprawą czasu wykonania.
