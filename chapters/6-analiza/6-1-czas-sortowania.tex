...
osiągając około 2,16~s. Dla Quick Sort uzyskano bardzo zbliżony średni czas wykonania, wynoszący około 2,17~s.
Merge Sort wymagał około 3,43~s, natomiast najdłuższy czas spośród badanych implementacji uzyskał Sample Sort, 
dla którego średni czas wykonania wyniósł około 6,17~s.
...
W~przypadku mniejszych zbiorów względna zmienność wyników była większa, co wynikało między innymi z~tego, 
że niewielkie różnice pomiędzy poszczególnymi pomiarami stanowiły większą część całkowitego czasu sortowania.
...
niemniej najlepsze wyniki osiągnięto przy różnej liczbie jednostek wykonawczych. 

Największe przyspieszenie w~stosunku do wykonania sekwencyjnego odnotowano dla Sample Sort i~wyniosło ono około 2,60. 
Najlepszy czas wykonania tego algorytmu wyniósł około 2,37~s przy wykorzystaniu 8 jednostek wykonawczych.

Nie oznaczało to jednak najkrótszego bezwzględnego czasu sortowania. 
Najlepszy wynik czasowy uzyskała implementacja Bucket Sort, dla której przy wykorzystaniu 16 jednostek wykonawczych wyniósł on około 1,20~s.

Uzyskane wyniki wskazują, że zastosowanie wariantu równoległego prowadziło do skrócenia czasu sortowania, 
