...
Obserwowany spadek efektywności wraz ze zwiększaniem liczby jednostek wykonawczych oznaczał, 
...
wynoszącą 2,6021 przy 8 jednostkach wykonawczych.
...
Uzyskane wyniki można również odnieść do prawa Amdahla omówionego w~rozdziale~\ref{sec:WydajnoscEfektywnosc}. 
Zgodnie z~prawem Amdahla możliwości uzyskania dalszego przyspieszenia są ograniczone przez tę część obliczeń, 
której nie można zrealizować równolegle. 
W~badanych implementacjach przejawiało się to brakiem proporcjonalnego wzrostu przyspieszenia wraz ze zwiększaniem liczby jednostek wykonawczych.

Przykładowo, dla Sample Sort przyspieszenie wzrosło z~1,5594 przy 2 jednostkach wykonawczych do 2,6021 przy 8 jednostkach. 
Dalsze zwiększanie liczby jednostek wykonawczych nie prowadziło już do poprawy przyspieszenia. 
Przy 16 jednostkach uzyskano wartość 2,5242, natomiast zwiększenie ich liczby do 32 spowodowało spadek przyspieszenia do 1,8933.
Podobną zależność można zaobserwować dla pozostałych algorytmów, 
dla których zwiększanie liczby jednostek wykonawczych nie prowadziło do proporcjonalnego wzrostu przyspieszenia. 
Wyniki te potwierdzają, że samo zwiększanie poziomu równoległości nie gwarantuje dalszego wzrostu wydajności.

Należy jednak pamiętać, że prawo Amdahla opisuje uproszczony, idealny model przyspieszenia i~nie uwzględnia wszystkich 
czynników występujących w~rzeczywistych obliczeniach równoległych. 
W~przeprowadzonych badaniach na uzyskiwane przyspieszenie wpływały dodatkowo między innymi czas potrzebny na utworzenie 
i~synchronizację procesów, podział danych pomiędzy procesy oraz sposób organizacji poszczególnych etapów obliczeń.
...
Dla największego zbioru, zawierającego 1~000~000 elementów, przyspieszenie wzrosło do 1,4807,
...
Dla 1~000 elementów wynosiło 0,8568, dla 10~000 0,8706, natomiast dla 100~000 i~1~000~000 elementów osiągnęło odpowiednio 0,8633 i~0,9828.
...
Dla 1~000 elementów wynosiło ono 1,2408, a~dla 10~000 elementów 0,9958. 
Przy 100~000 elementów wartość osiągnęła 1,0149, natomiast dla 1~000~000 elementów wzrosła do 1,8933.
...
a~zwiększenie liczby przetwarzanych elementów prowadziło do poprawy przyspieszenia jedynie w~części badanych implementacji.
