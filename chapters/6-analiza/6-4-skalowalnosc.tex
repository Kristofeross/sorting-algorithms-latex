...
Najkorzystniejsze wyniki skalowalności w~zakresie większej liczby jednostek wykonawczych uzyskała implementacja Bucket Sort, 
...
Największą korzyść odnotowano dla Bucket Sort przy największym analizowanym zbiorze, 
natomiast dla pozostałych implementacji zwiększenie rozmiaru danych nie okazało się 
wystarczające do efektywnego wykorzystania konfiguracji obejmującej 32 jednostki wykonawcze.