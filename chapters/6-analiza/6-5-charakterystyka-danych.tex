...
\begin{figure}[htbp]
    ...
    wykonania badanych algorytmów dla 1~000~000 elementów i~8 jednostek wykonawczych.}
...
natomiast dla duplikatów zmiennoprzecinkowych zwiększył do około 2,70~s. 
Uzyskane wyniki pokazują, że czas wykonania Quick Sort charakteryzował się większą
...
\begin{figure}[htbp]
    ...
    dla 1~000~000 elementów i~8 jednostek wykonawczych.}
...
Największą zmienność wyników wynikającą ze zmiany charakterystyki zbioru zaobserwowano dla Quick Sort, natomiast Bucket Sort
