...
Sample Sort również początkowo charakteryzwoał się poprawą wydajności.
...
Powtarzalność tych zależności dla dwóch typów danych sugeruje, że obserwowane zmiany wydajności wynikały głównie 
ze sposobem realizacji równoległości badanych algorytmów, a nie wyłącznie z typem przetwarzanych wartości.
