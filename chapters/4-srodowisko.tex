...
% version with NumPy
Biblioteka \texttt{NumPy}~\cite{bib:NumPy}, przeznaczona do przetwarzania danych numerycznych 
i~wykonywania operacji na tablicach, została wykorzystana w~implementacjach Bucket Sort oraz Sample Sort.
Zastosowano ją na etapie dystrybucji elementów do kubełków, między innymi do wyznaczania ich przypisania oraz grupowania danych.
Ponadto \texttt{NumPy} wykorzystano w~module analizy złożoności obliczeniowej oraz przy generowaniu wykresów.
% end
% version without NumPy
% Biblioteka \texttt{NumPy}~\cite{bib:NumPy}, przeznaczona do przetwarzania danych numerycznych i~wykonywania operacji na tablicach, 
% została wykorzystana pomocniczo podczas analizy i~prezentacji uzyskanych wyników. 
% Zastosowano ją w~module analizy złożoności obliczeniowej oraz przy generowaniu wybranych wykresów.
% end
...
Na etapie rozdzielania elementów do kubełków wykorzystano operacje biblioteki \texttt{NumPy}. % version with NumPy
% Rozdzielanie elementów do kubełków realizowano bezpośrednio w~języku Python poprzez wyznaczenie numeru kubełka dla każdego elementu. % version without NumPy
...
Na etapie dystrybucji elementów do kubełków wykorzystano operacje biblioteki \texttt{NumPy}. % version with NumPy
% Rozdzielanie elementów do kubełków realizowano bezpośrednio w~języku Python na podstawie wcześniej wyznaczonych wartości rozdzielających. % version without NumPy
