...
\begin{itemize}
    ...
    \item \textbf{Taktowanie bazowe CPU:} 3,00~GHz
    \item \textbf{Pamięć operacyjna RAM:} 128~GB
...
(ang. \textit{global interpreter lock}, GIL). Dzięki temu możliwe jest efektywne wykorzystanie wielu rdzeni procesora. 
...
Skróty zastosowane w~tabeli oznaczają PC -- \texttt{PARALLEL\allowbreak\_CUTOFF},
PSC -- \texttt{PARALLEL\allowbreak\_SIZE\allowbreak\_CUTOFF} oraz GSC -- \texttt{GROUP\allowbreak\_SIZE\allowbreak\_CUTOFF}.
...
Rozdzielanie elementów do kubełków realizowano bezpośrednio w~języku Python poprzez wyznaczenie numeru kubełka dla każdego elementu.
...
Rozdzielanie elementów do kubełków realizowano bezpośrednio w~języku Python na podstawie wcześniej wyznaczonych wartości rozdzielających. 
